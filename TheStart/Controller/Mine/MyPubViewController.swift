...
class MyPubViewController: BaseViewController {
    ...
    var controller3:TipOffViewController!
    var controller4:MuiscListController!
    ...
    override func viewDidLoad() {
        ...
        controller4.isMypub = true
        controller4.title = "我的音乐"
...
extension MyPubViewController: PMKPageMenuControllerDelegate
{
