...
class WorkerPubViewController: BaseViewController {
    ...
    func initHeadView(){
        ...
        headView.frame = CGRect.init(x: 0, y: 0, width: screenWidth, height: 350)
        
        headerBgView = UIView.init(frame:  CGRect.init(x: 0, y: 0, width: screenWidth, height: 350))
